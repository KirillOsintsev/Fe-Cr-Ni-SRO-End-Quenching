...
# --- Параметры ---
FOLDER_PATH = '/Users/osintsevkirill/Yandex.Disk.localized/Science/Postdoc_project/Fe-Cr-Ni-SRO-End-Quenching/02_Analytical_NIMM'  # Укажите путь к папке с вашими JSON файлами
...
COLORBAR_MIN = 0.008  # Минимальное значение для цветовой шкалы
COLORBAR_MAX = 0.04 # Максимальное значение для цветовой шкалы
"""

TARGET_ALPHA = 'alpha_FeNi'  # Какую альфу отображать ('alpha_FeNi', 'alpha_NiCr', 'alpha_FeCr')
COLORBAR_MIN = 0.004  # Минимальное значение для цветовой шкалы
COLORBAR_MAX = 0.03 # Максимальное значение для цветовой шкалы
