...
ALLOY_COMPONENTS = {
    'c1': 0.3, 'c2': 0.3, # Fe (итого 20%)
    'c3': 0.1, 'c4': 0.1, # Ni (итого 50%)
    'c5': 0.1, 'c6': 0.1  # Cr (итого 30%)
}

alloy_name = "Fe60Ni20Cr20"  # Для отображения в заголовке и инфо-блоке
...
plot_alloy_total_dos('DOS_Fe60Ni20Cr20_atom000001', e_range=[-10, 5], sigma_ev=0.06)